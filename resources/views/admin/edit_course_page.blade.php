            ...
            <div class="form_container">
                <form action="{{ url('update_course', $course->id) }}" method="POST">
                    ...
                    <div class="form_element">
                        ...
                        <input name="title" value="{{ $course->title }}"></input>
                    </div>
                    ...
                    <div class="form_element">
                        ...
                        <select name="dept_id" id="">
                            ...
                            @foreach ($departments as $department)
                                ...
                                <option value="{{ $department->id }}" {{ $course->department_id == $department->id ? 'selected' : '' }}>{{ $department->dept_name }}</option>
