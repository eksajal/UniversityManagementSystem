                ...
                <table>
                    ...
                    @foreach ($notice as $notice)
                     ...
                     <tr>
                        ...
                        <td><a class="btn btn-secondary" href="{{ url('edit_notice_page', $notice->id) }}">Update</a></td>
                        <td><a class="btn btn-danger" href="{{ url('delete_notice', $notice->id) }}">Delete</a></td>
                     </tr>
