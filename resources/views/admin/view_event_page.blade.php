                ...
                <table>
                    ...
                    @foreach ($event as $event)
                     ...
                     <tr>
                        ...
                        <td><a class="btn btn-secondary" href="{{ url('edit_event_page', $event->id) }}">Update</a></td>
                        <td><a class="btn btn-danger" href="{{ url('delete_event', $event->id) }}">Delete</a></td>
                     </tr>
