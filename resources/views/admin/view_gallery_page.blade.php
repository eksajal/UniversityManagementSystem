                ...
                <table>
                    ...
                    @foreach ($gallery as $gallery)
                     ...
                     <tr>
                        ...
                        <td>
                            <img width="150px" height="100px" src="galleryImage/{{ $gallery->image}}" alt="">
                        </td>
                        <td><a class="btn btn-secondary" href="{{ url('edit_gallery_page', $gallery->id) }}">Update</a></td>
                        <td><a class="btn btn-danger" href="{{ url('delete_gallery', $gallery->id) }}">Delete</a></td>
                     </tr>
