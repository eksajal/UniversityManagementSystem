    ...
    <div class="page-content">
        <div class="page-header">
            <div class="container-fluid">
                ...
                <div class="intro">
                    <h1>View <span>Departments</span></h1>
                </div>
                ...
                <table>
                    ...
                    @foreach ($dept as $dept)
                     ...
                     <tr>
                        ...
                        <td><a class="btn btn-secondary" href="{{ url('edit_dept_page', $dept->id) }}">Update</a></td>
                        <td><a class="btn btn-danger" href="{{ url('delete_dept', $dept->id) }}">Delete</a></td>
                     </tr>
