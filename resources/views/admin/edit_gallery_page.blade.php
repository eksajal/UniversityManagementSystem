    ...
    <div class="page-content">
        <div class="page-header">
            <div class="container-fluid">
                ...
                <div class="intro">
                    <h1>Update <span>Gallery</span></h1>
                </div>
        ...
        <div class="div_center">
            <div class="form_container">
                <form action="{{ url('update_gallery', $gallery->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form_element">
                        <label for="">Intro</label>
                        <input type="text" name="intro" value="{{ $gallery->intro }}">
                    </div>
