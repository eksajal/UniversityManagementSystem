                ...
                <table>
                    ...
                    @foreach ($students as $student)
                     ...
                     <tr>
                        ...
                        <td><a class="btn btn-secondary" href="{{ url('edit_student_page', $student->id) }}">Update</a></td>
                        <td><a class="btn btn-danger" href="{{ url('delete_student', $student->id) }}">Delete</a></td>
                     </tr>
