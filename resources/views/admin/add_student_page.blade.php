    ...
    <div class="page-content">
        ...
        <div class="div_center">
            <div class="form_container">
                <form action="{{ url('create_student') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form_element">
                        ...
                        <input type="number" name="student_number" placeholder="Enter student's number">
                    </div>

                    <div class="form_element">
                        <label for="">Guardian's Number</label>
                        <input type="number" name="guardian_number" placeholder="Enter guardian's number">
                    </div>
                    ...
                    <div class="form_element">
                        ...
                        <input type="text" name="address" placeholder="Enter student's address">
                    </div>
