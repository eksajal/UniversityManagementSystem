                ...
                <table>
                    ...
                    @foreach ($faculty as $faculty)
                     ...
                     <tr>
                        ...
                        <td>{{ $faculty->course_title }}</td>
                        <td>{{ Str::limit($faculty->description, 50) }}</td>
                        <td>
                            <img width="150px" height="100px" src="facultyImage/{{ $faculty->image}}" alt="">
                        </td>
                        <td><a class="btn btn-secondary" href="{{ url('edit_faculty_page', $faculty->id) }}">Update</a></td>
                        <td><a class="btn btn-danger" href="{{ url('delete_faculty', $faculty->id) }}">Delete</a></td>
                     </tr>
